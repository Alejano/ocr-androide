...
import 'Component/barcode_detail.dart';
import 'Component/face_detail.dart';
import 'Component/ocr_text_detail.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        ...
        colorScheme:const ColorScheme.light(background: Colors.lime)
      ),
